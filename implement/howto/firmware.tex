...
calibration structure for the calibration module to fill in.  Table
\ref{tab:cal_organization} shows the duties of each module.
...
\end{tabular}
\caption{How calibration duties are split between the calibration and
  consumer modules.\label{tab:cal_organization}}
\end{center}
\end{table}
