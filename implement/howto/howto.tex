...
\makeindex{user_commands}
\makeindex{internal_commands}
...
\printindex{user_commands}{Alphabetical command index}

%Internal SRS commands
\ifthenelse{\equal{\isforme}{1}}{
\clearpage
\printindex{internal_commands}{Internal command index}
}{}
