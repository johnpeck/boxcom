...
* TODO Work on Butterfly board [/]
** TODO Run kit for 3
** TODO Make a drawing in the howto showing connections
*** TODO Show show connection to ADC7 at PF4 (J401 pins 1 and 2) 
...
* TODO Work on mechanical drawing [6/7]
  - Mechanical drawing is [[file:implement/drawings/budbox.fig][here]].
** DONE Create AVR Butterfly drawing in inkscape
...
** DONE Add mounting holes to butterfly drawing in library
