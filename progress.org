...
** TODO Make blog post about multi-line bash commands and their comments
** DONE Place components on rs232io page
** TODO Place components on auxiliary power page
** TODO Place components on monitored power page
