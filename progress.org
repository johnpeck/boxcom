...
** TODO Work through chapter 4.6 of Pratt
...
* Work on code
** TODO Write current measurement function
   - Takes data from the ADC, applies calibration, and returns output in uA.
** TODO Hello function becomes *idn
