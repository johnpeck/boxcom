...
* TODO Work on USB board layout [14/15]
...
** TODO Put up placeholder bnc2adc.com site
** TODO Add part number and rev code to top silk
...
** TODO Follow checklist.org to check over gerbers output to output directory
